// src/lib.rs
/*
 * Core library for MigrationPlan
 */
...
#[derive(Debug)]
pub struct MigrationPlanProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MigrationPlanProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MigrationPlan processing");
    
    let mut processor = MigrationPlanProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MigrationPlanProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MigrationPlanProcessor::new(false);
